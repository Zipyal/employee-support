        ...
        <div class="container">
            <div class="row mt-2 mb-5">
                ...
                <div class="col text-end">
                    <a class="btn btn-sm btn-success" href="{{ route('material-add') }}"><strong class="fs-1 m-0 lh-1">+</strong></a>
                </div>
            </div>
    ...
    <table class="table table-hover">
        ...
        @foreach($materials as $i => $material)
            <tr>
                ...
                <td>{{ $material->text }}</td>
                <td>
                    <a class="btn btn-sm btn-outline-dark" href="{{ route('material-show', ['id' => $material]) }}">👁</a>
